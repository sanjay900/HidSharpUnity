...
namespace HidSharpUnity
{
    ...
    public class ControlRemappingDemo1 : MonoBehaviour
    {
        ...
        RockbandCalibration calibration;
        HidSharpUnity hidSharp;
        ...
        private void TestHID()
        {
            foreach (Joystick joystick in ReInput.controllers.Joysticks)
            {
                var device = hidSharp.findHidSharpDevice(joystick);
                calibration.disableSensors(device);
            }
        }
        ...
        private void Initialize()
        {
            ...
            calibration = gameObject.AddComponent<RockbandCalibration>();
            hidSharp = new HidSharpUnity();
            TestHID();
        }
